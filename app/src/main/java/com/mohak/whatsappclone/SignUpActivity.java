    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.btnSignUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(binding.username.getText().toString().length()==0 || binding.etEmail.getText().toString().length()==0
                || binding.etPass.getText().toString().length()==0){
                    Toast.makeText(SignUpActivity.this, "All inputs required!!", Toast.LENGTH_SHORT).show();
                }
                else{
                    progressDialog.show();
